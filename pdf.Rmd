...
author: "This is a PDF of an online report. Click [here](https://northwest-syria-cash-working-group.github.io/cash_reporting_20230425/) to access it"
output:
  pdf_document:
    toc: yes
...
This is a static version of the original interactive plot, which can be accessed [here](https://northwest-syria-cash-working-group.github.io/cash_reporting_20230425/#map-of-activities).
...
cbr %>% 
  ...
  labs(title = "Communities reached and planned -- CWG partners", 
       subtitle = "Planned in green, completed in purple, size shows number of persons", 
       colour = "Status") +
  guides(size = "none")
...
This is a static version of the original interactive plot, which can be accessed [here](https://northwest-syria-cash-working-group.github.io/cash_reporting_20230411/#htmlwidget-dbd3df0753e9987e1cd6)
...
This interactive table does not work in a PDF. Please access the original [here](https://northwest-syria-cash-working-group.github.io/cash_reporting_20230425/#interactive-reference-table-at-sub-district-level)
